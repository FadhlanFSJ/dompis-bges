...
<html>
<head>
	<title>Dashboard BGES SBS</title>
							...
							<div class="col-lg">
								<div class="p-5">
									<div class="text-center">
										<img src="<?php echo base_url() ?>assets/img/icon1.png" style="width: 60px; height: 70px"> <b>BGES SURABAYA SELATAN</b>
										<h1 class="h2 text-center push-top-bottom animation-slideDown" style="color: black"><b>LOGIN</b></h1><br>

										<?php if($this->session->flashdata('status')) : ?>
											<div class="alert alert-danger alert-dismissable">
												<button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
												<strong>Login Gagal!</strong> Username atau Password <?php echo $this->session->flashdata('status');?>
											</div>
										<?php endif;?>
										...
										<form action="<?php echo site_url('Login/loginProses') ?>" method="post">
											<div class="form-group">
												<input type="text" name="username" class="form-control" placeholder="Masukkan username (NIK)" maxlength="8" autofocus>
