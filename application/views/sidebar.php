<!-- Sidebar -->
<ul class="navbar-nav bg-sidebar-theme sidebar sidebar-dark accordion" id="accordionSidebar">

	<!-- Sidebar - Brand -->
	<a class="sidebar-brand d-flex align-items-center justify-content-center bg-white" href="<?php echo site_url('Dashboard') ?>">
		<div class="sidebar-brand-icon">
			<img width="45px" height="50px" src="<?php echo base_url(); ?>assets/img/icon1.png">
		</div>
		<div class="sidebar-brand-text mx-3 text-gray-800">BGES SBS</div>
	</a>
	...
	<?php if ($this->session->userdata('level') == "Admin") { ?>
		...
		<li class="nav-item">
			...
			<div id="collapseTicket" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
				<div class="bg-dark py-2 collapse-inner rounded">
					<h6 class="collapse-header">Dropdown</h6>
					<a class="collapse-item" href="<?php echo site_url('List_ticket/list_approve') ?>">Tiket Received</a>
					<a class="collapse-item" href="<?php echo site_url('List_ticket/index') ?>">List All Tiket</a>
					<a class="collapse-item" href="<?php echo site_url('List_ticket/tiket_datin') ?>">List Tiket Datin</a> 
					<a class="collapse-item" href="<?php echo site_url('List_ticket/tiket_hsi') ?>">List Tiket HSI</a>
					<a class="collapse-item" href="<?php echo site_url('List_ticket/tiket_voice') ?>">List Tiket VOICE</a>
				<!--<a class="collapse-item" href="<?php echo site_url('List_ticket/produktiv') ?>">Produktivitas Teknisi</a>-->
		...
		<hr class="sidebar-divider">
		<li class="nav-item">
			<a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapsePro" aria-expanded="true" aria-controls="collapse">
			...
			<div id="collapsePro" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
				<div class="bg-dark py-2 collapse-inner rounded">
					<h6 class="collapse-header">Dropdown</h6>
					<a class="collapse-item" href="<?php echo site_url('List_ticket/produktiv') ?>">Produktivitas Teknisi</a>
					<a class="collapse-item" href="<?php echo site_url('List_ticket/produktiv_hd') ?>">Produktivitas HD</a>
					<a class="collapse-item" href="<?php echo site_url('List_ticket/produktiv_tl') ?>">Produktivitas TL</a>
				</div>
			</div>
		</li>
		...
		<li class="nav-item">
			...
			<div id="collapseOffice" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
				<div class="bg-dark py-2 collapse-inner rounded">
					<h6 class="collapse-header">Dropdown</h6>
					<a class="collapse-item" href="<?php echo site_url('Departemen') ?>">Divisi</a>
					<a class="collapse-item" href="<?php echo site_url('Subdept') ?>">Unit</a>
					<a class="collapse-item" href="<?php echo site_url('Jabatan') ?>">Position</a>
					<a class="collapse-item" href="<?php echo site_url('Pegawai') ?>">Naker</a>
					<a class="collapse-item" href="<?php echo site_url('Lokasi') ?>">Sektor</a>
				</div>
			</div>
		</li>
		...
		<li class="nav-item">
			...
			<div id="collapseSetting" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
				<div class="bg-dark py-2 collapse-inner rounded">
					...
					<a class="collapse-item" href="<?php echo site_url('Subkategori') ?>">Sub Kategori</a>
					<a class="collapse-item" href="<?php echo site_url('Kondisi') ?>">Priority</a>
					<a class="collapse-item" href="<?php echo site_url('Informasi') ?>">Informasi Umum</a>
				</div>
			</div>
		</li>
	...
	<hr class="sidebar-divider my-0">
		<!-- Nav Item - Dashboard -->
		<li class="nav-item">
			<a href="<?php echo site_url('List_ticket_hd/buat') ?>" class="nav-link">
		...
		<li class="nav-item">
			...
			<div id="collapseTicket" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
				<div class="bg-dark py-2 collapse-inner rounded">
					<h6 class="collapse-header">Dropdown</h6>
					<a class="collapse-item" href="<?php echo site_url('List_ticket/list_approve') ?>">Tiket Received</a>
					<a class="collapse-item" href="<?php echo site_url('List_ticket/index') ?>">List Tiket</a>
				</div>
			</div>
		</li>
