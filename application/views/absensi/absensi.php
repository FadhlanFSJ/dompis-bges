<div class="container-fluid">
    ...
    <h1 class="h3 mb-0 text-gray-800">List Absensi Teknisi</h1><hr>
    <div class="flash-data" data-flashdata="<?php echo $this->session->flashdata('status')?>"></div>

    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-gray-800">Data Teknisi</h6><hr>
            <div class="">
                            ...
                            <?php $no = 1; foreach ($karyawan as $row){?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <input type="checkbox" name="status_absensi[<?php echo $row->nik; ?>]" value="1" <?php echo ($row->status_absensi == 1) ? 'checked' : ''; ?>>
                                    </td>
                                </tr>
                            <?php $no++; } ?>
                        </tbody>
